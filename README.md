...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https%3A%2F%2Fgithub.com%2Fking565%2FDeploy-vless)
...
`UUID` 默认为 `1849fb71-72ab-440c-8011-0772b308e225` 你也可以在部署时自由修改（建议修改）。
